...
<head>
    ...
    <style>
        ...
        /* --- Make Main Slider 100vh on Desktop --- */
        @media (min-width: 1200px) {
            ...
            /* REDUCED fonts and spaces in main-slider */
            .main-slider__content p {
                font-family: 'Nunito', sans-serif !important; /* Simple readable font */
        ...
        @media (min-width: 1200px) {
            .main-slider .swiper-slide {
                height: calc(100vh - 110px) !important; /* Full viewport height minus header */
                display: flex !important;
                align-items: center !important;
            }
            .main-slider .container {
            ...
            /* Increase fonts and adjust spaces in main-slider */
            .main-slider__content p {
                            ...
                            <div class="footer-widget__column footer-widget__contact">
                                ...
                                <ul class="list-unstyled footer-widget__contact-list">
                                    <li>
                                        ...
                                        <div class="text">
                                            <p><span>Call Anytime</span><a href="tel:+2340000000000">+234 000 000 0000</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon"><i class="icon-message"></i></div>
                                        <div class="text">
                                            <p><span>Send Email</span><a href="mailto:info@networkformedicalmissions.org">info@networkformedicalmissions.org</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li><i class="fa fa-envelope"></i><a href="mailto:info@networkformedicalmissions.org">info@networkformedicalmissions.org</a></li>
                <li><i class="fa fa-phone-alt"></i><a href="tel:+2340000000000">+234 000 000 0000</a></li>
            </ul>
        </div>
    </div>
